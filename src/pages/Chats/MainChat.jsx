...
tea m          {
            activeConversation && activeUser ? (
              ...
              <div className=" h-full flex flex-col gap-10 pt-32 p-5 align-center">
                <div className="h-2/5">
                  <svg
                  ...
                  >
                    <path
                      id="uuid-f8ba9176-caa4-4aaa-aa33-5402b823e72a-893"
                    ...
                    <g>
                      <path
                        id="uuid-070545a9-7559-45f6-9b62-076b2f028fa8-894"
                    ...
                    <g>
                      <polygon points="178.34658 515.12397 199.64263 515.1219 209.77329 432.97905 178.34231 432.98125 178.34658 515.12397" fill="#ffb6b6" />
                      <path
                    ...
                    <rect
                      ...
                      fill="#2f2e41"
                    />
                    <polygon points="464.72245 112.27854 462.87423 89.94297 438.29928 89.94297 432.85138 113.60704 464.72245 112.27854" fill="#a0616a" />
                    <polygon points="464.72245 112.27854 462.87423 89.94297 438.29928 89.94297 432.85138 113.60704 464.72245 112.27854" opacity=".1" />
                    <polygon points="194.46134 87.46728 194.89207 58.74385 177.17918 47.70229 157.91851 71.26224 194.46134 87.46728" fill="#ffb6b6" />
                    <polygon points="194.46134 87.46728 195.60781 59.45958 177.17918 47.70229 183.44031 82.3631 194.46134 87.46728" opacity=".1" />
                    ...
                    />
                    <g>
                      <polygon points="57.09417 483.30825 75.85506 493.38549 123.65611 425.81969 95.9672 410.94587 57.09417 483.30825" fill="#ffb6b6" />
                      <path
                    ...
                    />
                    <g>
                      <polygon points="462.72147 517.62917 444.41088 517.62739 435.70042 447 462.72515 447.00189 462.72147 517.62917" fill="#a0616a" />
                      <path
                    ...
                    <g>
                      <polygon points="534.85443 496.05084 517.9276 503.03371 482.93516 441.06897 507.91729 430.76223 534.85443 496.05084" fill="#a0616a" />
                      <path
                    ...
                    />
                    <path
                      id="uuid-03f01c0a-1974-4ec8-8b69-52a915a70377-895"
                    ...
                    <g>
                      <path
                        id="uuid-7eb47ac4-3db4-4d62-bd0a-b38893e38622-896"
                ...
                <ul class="list-disc flex flex-col  text-start text-sm mx-auto ">
                  <li className="text-[#28D8AE]">
                    <p className="text-black">لو واجهت أي إسائه ما تترددش في انك تبلغ عن اللي بيكلمك </p>
                  </li>
                  <li className="text-[#28D8AE] ">
                    <p className="text-black">تقدر تبلغ عن اي اسائة من خلال الايكون دي</p>{" "}
                    <p className="text-black">هتلاقيها في اكترمن مكان في التطبيق حسب انت عايز تبلغ عن ايه </p>
                  </li>
                  <li className="text-[#28D8AE]">
                    <p className="text-black">وانت بتستلم الكتاب حاول تكون في مكان عام ويفضل ما تروحش لوحدك</p>
                  </li>
                </ul>
              </div>
            ) : null
