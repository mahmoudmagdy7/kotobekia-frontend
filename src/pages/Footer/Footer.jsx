...
const Footer = () => {
  return (
    <>
      <footer style={{ fontFamily: "Poppins" }} className="pt-10 pb-4 bg-white border-b-2 border-[#dddcde]">
      ...
      <div style={notoFont} className="copyRight pt-4 pb-3 bg-white text-black">
