...
const ProfileDesktop = ({ addActive, removeActive }) => {
  const dispatch = useDispatch();

  const { userData } = useSelector((state) => state.userData);

  const x = useSelector((state) => state.report);
  console.log(userData);
  console.log(x);

  const handleActive = (iconClass, itemClass) => {
    removeActive(".data-setting .item .icon", ".profile-parent .item");
    addActive(iconClass, itemClass);
  };
            ...
            <div className="head-profile pt-12 mb-12 bg-white rounded-t-[14px]  ">
              ...
              <div className="data-setting select-none  mt-14 py-3 border-t-1 border-[#EDEDED] px-24 flex  items-center">
                <div className="parent flex items-center gap-6">
                  ...
                  {/************ Ubdate Person ************/}
                  <div className="ubdate-preson item cursor-pointer flex items-center gap-1">
                    <div className="icon">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="25"
                  ...
                  <div
                    onClick={() =>
                      handleActive(
                        ".data-setting .favorite .icon",
                        ".profile-parent .favorite"
                      )
                    }
                  ...
                  {/************ My Posts ************/}
                  <div
                    onClick={() =>   handleActive(".data-setting .my-post .icon" , ".profile-parent .my-post")}
                    ...
                    <div className="icon">
                      ...
                      >
                        <path
                          fill-rule="evenodd"
                          clip-rule="evenodd"
                          d="M5.642 1.53125H5.733C6.51916 1.53123 7.17474 1.53121 7.69517 1.60118C8.24449 1.67503 8.74044 1.83749 9.13898 2.23603C9.53752 2.63456 9.69998 3.13051 9.77383 3.67983C9.8438 4.20026 9.84378 4.85582 9.84375 5.64198V15.358C9.84378 16.1442 9.8438 16.7997 9.77383 17.3202C9.69998 17.8695 9.53752 18.3654 9.13898 18.764C8.74044 19.1625 8.24449 19.325 7.69517 19.3988C7.17474 19.4688 6.51917 19.4688 5.733 19.4688H5.64201C4.85584 19.4688 4.20027 19.4688 3.67983 19.3988C3.13051 19.325 2.63456 19.1625 2.23603 18.764C1.83749 18.3654 1.67503 17.8695 1.60118 17.3202C1.53121 16.7997 1.53123 16.1442 1.53125 15.358V5.642C1.53123 4.85584 1.53121 4.20026 1.60118 3.67983C1.67503 3.13051 1.83749 2.63456 2.23603 2.23603C2.63456 1.83749 3.13051 1.67503 3.67983 1.60118C4.20026 1.53121 4.85584 1.53123 5.642 1.53125ZM3.85472 2.90197C3.45094 2.95626 3.27813 3.05008 3.1641 3.1641C3.05008 3.27813 2.95626 3.45094 2.90197 3.85472C2.84515 4.27738 2.84375 4.84399 2.84375 5.6875V15.3125C2.84375 16.156 2.84515 16.7226 2.90197 17.1453C2.95626 17.5491 3.05008 17.7219 3.1641 17.8359C3.27813 17.9499 3.45094 18.0437 3.85472 18.098C4.27738 18.1549 4.84399 18.1563 5.6875 18.1563C6.53101 18.1563 7.09763 18.1549 7.52028 18.098C7.92406 18.0437 8.09687 17.9499 8.2109 17.8359C8.32493 17.7219 8.41875 17.5491 8.47303 17.1453C8.52986 16.7226 8.53125 16.156 8.53125 15.3125V5.6875C8.53125 4.84399 8.52986 4.27738 8.47303 3.85472C8.41875 3.45094 8.32493 3.27813 8.2109 3.1641C8.09687 3.05008 7.92406 2.95626 7.52028 2.90197C7.09763 2.84515 6.53101 2.84375 5.6875 2.84375C4.84399 2.84375 4.27738 2.84515 3.85472 2.90197Z"
                        />
                        <path
                          fill-rule="evenodd"
                          clip-rule="evenodd"
                          d="M15.267 9.40625H15.358C16.1442 9.40623 16.7997 9.4062 17.3202 9.47618C17.8695 9.55003 18.3654 9.71249 18.764 10.111C19.1625 10.5096 19.325 11.0055 19.3988 11.5548C19.4688 12.0753 19.4688 12.7308 19.4688 13.517V15.358C19.4688 16.1441 19.4688 16.7998 19.3988 17.3202C19.325 17.8695 19.1625 18.3654 18.764 18.764C18.3654 19.1625 17.8695 19.325 17.3202 19.3988C16.7998 19.4688 16.1442 19.4688 15.3581 19.4688H15.267C14.4809 19.4688 13.8253 19.4688 13.3048 19.3988C12.7555 19.325 12.2596 19.1625 11.861 18.764C11.4625 18.3654 11.3 17.8695 11.2262 17.3202C11.1562 16.7997 11.1562 16.1442 11.1563 15.358V13.517C11.1562 12.7308 11.1562 12.0753 11.2262 11.5548C11.3 11.0055 11.4625 10.5096 11.861 10.111C12.2596 9.71249 12.7555 9.55003 13.3048 9.47618C13.8253 9.4062 14.4808 9.40623 15.267 9.40625ZM13.4797 10.777C13.0759 10.8313 12.9031 10.9251 12.7891 11.0391C12.6751 11.1531 12.5813 11.3259 12.527 11.7297C12.4701 12.1524 12.4688 12.719 12.4688 13.5625V15.3125C12.4688 16.156 12.4701 16.7226 12.527 17.1453C12.5813 17.5491 12.6751 17.7219 12.7891 17.8359C12.9031 17.9499 13.0759 18.0438 13.4797 18.098C13.9024 18.1549 14.469 18.1563 15.3125 18.1563C16.156 18.1563 16.7226 18.1549 17.1453 18.098C17.5491 18.0438 17.7219 17.9499 17.8359 17.8359C17.9499 17.7219 18.0438 17.5491 18.098 17.1453C18.1549 16.7226 18.1563 16.156 18.1563 15.3125V13.5625C18.1563 12.719 18.1549 12.1524 18.098 11.7297C18.0438 11.3259 17.9499 11.1531 17.8359 11.0391C17.7219 10.9251 17.5491 10.8313 17.1453 10.777C16.7226 10.7201 16.156 10.7188 15.3125 10.7188C14.469 10.7188 13.9024 10.7201 13.4797 10.777Z"
                        />
                        <path
                          fill-rule="evenodd"
                          clip-rule="evenodd"
                          d="M14.4154 1.53125C14.0265 1.53125 13.7018 1.53124 13.4353 1.54943C13.1578 1.56836 12.8958 1.60917 12.6417 1.71442C12.0521 1.95864 11.5836 2.42707 11.3394 3.01667C11.2342 3.27076 11.1934 3.53285 11.1744 3.81031C11.1562 4.07685 11.1562 4.4015 11.1563 4.79041V4.8346C11.1562 5.2235 11.1562 5.54816 11.1744 5.8147C11.1934 6.09216 11.2342 6.35424 11.3394 6.60834C11.5836 7.19793 12.0521 7.66637 12.6417 7.91059C12.8958 8.01584 13.1578 8.05665 13.4353 8.07558C13.7018 8.09377 14.0265 8.09376 14.4154 8.09375H16.2096C16.5985 8.09376 16.9232 8.09377 17.1897 8.07558C17.4672 8.05665 17.7292 8.01584 17.9833 7.91059C18.5729 7.66637 19.0414 7.19793 19.2856 6.60834C19.3908 6.35424 19.4317 6.09216 19.4506 5.8147C19.4688 5.54816 19.4688 5.2235 19.4688 4.8346V4.7904C19.4688 4.4015 19.4688 4.07684 19.4506 3.81031C19.4317 3.53285 19.3908 3.27076 19.2856 3.01667C19.0414 2.42707 18.5729 1.95864 17.9833 1.71442C17.7292 1.60917 17.4672 1.56836 17.1897 1.54943C16.9232 1.53124 16.5985 1.53125 16.2097 1.53125H14.4154ZM13.1439 2.92701C13.2115 2.89905 13.314 2.87325 13.5247 2.85888C13.7412 2.84411 14.0208 2.84375 14.4375 2.84375H16.1875C16.6042 2.84375 16.8838 2.84411 17.1004 2.85888C17.311 2.87325 17.4136 2.89905 17.4811 2.92701C17.7491 3.03802 17.962 3.25094 18.073 3.51894C18.101 3.58645 18.1268 3.68902 18.1411 3.89965C18.1559 4.11618 18.1563 4.39583 18.1563 4.8125C18.1563 5.22918 18.1559 5.50882 18.1411 5.72535C18.1268 5.93599 18.101 6.03855 18.073 6.10606C17.962 6.37406 17.7491 6.58699 17.4811 6.698C17.4136 6.72596 17.311 6.75175 17.1004 6.76612C16.8838 6.7809 16.6042 6.78125 16.1875 6.78125H14.4375C14.0208 6.78125 13.7412 6.7809 13.5247 6.76612C13.314 6.75175 13.2115 6.72596 13.1439 6.698C12.8759 6.58699 12.663 6.37406 12.552 6.10606C12.524 6.03855 12.4983 5.93599 12.4839 5.72535C12.4691 5.50882 12.4688 5.22918 12.4688 4.8125C12.4688 4.39583 12.4691 4.11618 12.4839 3.89965C12.4983 3.68902 12.524 3.58645 12.552 3.51894C12.663 3.25094 12.8759 3.03802 13.1439 2.92701Z"
                        />
                      </svg>
                    </div>
                    <span className="text-[#131313] font-medium text-sm">
