...
const ProfileMobile = () => {
  ...
  return (
    <>
      {userData ? (
        <section className="lg:hidden profile-mobile py-10">
          <div className="container">
            ...
            <div className="personal-user cursor-pointer mb-6">
              <div className="user-img mx-auto mb-4 w-[96px] h-[96px] relative flex justify-center items-center bg-[#D9D9D9] rounded-full">
                <div className="img ">
                  <SolaIcons.User size={60} color="#1C274C" />
            ...
            <div className="data-setting  my-5 pt-3 pb-1 bg-white rounded-xl">
              <div className="parent px-3 ">
                {/* Personal data  */}
                <div className="presonal cursor-pointer py-3 flex items-center gap-1 border-b-2  border-[#EDEDED]">
                  <SolaIcons.User size={23} color="#747474" />
                ...
                <div className="Ads cursor-pointer py-3 flex items-center gap-1 border-b-2  border-[#EDEDED]">
                  <SolaIcons.Heart size={24} color="#747474" />
                  <span className="text-[#131313] font-medium text-sm">
                    الاعلانات المفضلة
                  </span>
                </div>
                ...
                <div className="lang cursor-pointer py-3 flex items-center gap-1 border-b-2  border-[#EDEDED]">
                  <SolaIcons.TextSquare size={24} color="#747474" />
                  <span className="text-[#131313] font-medium text-sm">
                    اللغة
                  </span>
                </div>
                {/* Langauge */}
                {/* dark mode  */}
                <div className="dark-mode cursor-pointer py-3 flex items-center gap-1 border-b-2  border-[#EDEDED]">
                  <SolaIcons.Sun size={24} color="#747474" />
                ...
                <div className="help cursor-pointer py-3 flex items-center gap-1 border-b-2  border-[#EDEDED]">
                  <SolaIcons.InfoSquare size={24} color="#28D8AE" />
                  <span className="text-[#131313] font-medium text-sm">
                    مساعدة
                  </span>
                </div>
                ...
                <div className="problem cursor-pointer py-3 flex items-center gap-1">
                  <SolaIcons.ShieldWarning size={24} color="#FA5057" />
                  <span className="text-[#131313] font-medium text-sm">
                    التبليغ عن مشكلة
                  </span>
                </div>
