...
const PostDetails = () => {
  ...
  function getRelatedData() {
    return axios({
      method: "get",
      url: `${config.bseUrl}/api/v1/posts/specific/${id}`,
      headers: {
  ...
  /* open conversation with the author of the post */
  ...
  return (
    <>
      {data ? (
        <section className="postDetails py-[50px]">
            ...
            <div className="lg:grid lg:grid-cols-12 gap-8">
              <div className="books lg:col-span-8">
                ...
                <div className="slider">
                  ...
                  {/* --------- slider images large ---------  */}
                  {/* ----------- imags thumps ----------- */}
                  <div className="thumps flex gap-6 relative ">
                    {/* ------------ THUMBNAILS ------------ */}
                    <div ref={thumbnailRef} className="keen-slider thumbnail">
                      ...
                      <div className="keen-slider__slide number-slide6 cursor-pointer">
                        <img
                          src="/assets/imgPost.png"
                          alt=""
                          className="rounded-2xl w-[200px] mb-6"
                    ...
                    <div className="userName flex items-center">
                      <div className="text-center me-4">
                        <h5 className="text-base text-black font-semibold mb-0">
                          {data?.data?.result?.createdBy?.fullName}
                        </h5>
                        <Link
                          to={`/userProfile/${data?.data?.result?.createdBy?._id}`}
                        >
                          <span className="text-[10px] underline text-black block cursor-pointer">
                            عرض الملف الشخصي
                          </span>
                        </Link>
                      </div>{" "}
