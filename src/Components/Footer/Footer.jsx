            ...
            <div className="item py-5 px-6">
              ...
              <div className="icons my-4 flex justify-start lg:justify-center ">
                <div className="flex items-center gap-[10px] ">
                  {/* ----- linked in ----- */}
                  <Link to="https://www.linkedin.com/company/kotobekia" target="_blank" className="icon ">
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="32px" viewBox="0 0 48 48">
                  ...
                  {/* ----- facebook ----- */}
                  <Link to="https://www.facebook.com/kotobekia" target="_blank" className="icon ">
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="32px" viewBox="0 0 48 48">
                  ...
                  {/* ----- youtube ----- */}
                  <Link to="https://www.youtube.com/@Kotobekia" target="_blank" className="icon ">
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="32px" viewBox="0 0 48 48">
                      <path
                        fill="#FF3D00"
                  ...
                  {/* ----- telegram ----- */}
                  <Link to="https://t.me/kotobekia" target="_blank" className="icon ">
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="32px" viewBox="0 0 48 48">
                  ...
                  {/* ----- Instagram ----- */}
                  <Link to="https://www.instagram.com/kotobekia" target="_blank" className="icon ">
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="32px" viewBox="0 0 48 48">
                      <path
                        fill="#304ffe"
                  ...
                  {/* ----- whatsapp channel ----- */}
                  <Link to="https://chat.whatsapp.com/HmNIZTOERoxGgF4e2g8oUY" target="_blank" className="icon ">
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="34px" viewBox="0 0 48 48">
                      <path
                        fill="#fff"
