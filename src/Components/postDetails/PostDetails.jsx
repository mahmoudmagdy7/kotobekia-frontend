...
// import dsd from '../../../public/assets/images/ad/ads.png'
...
const PostDetails = () => {
  ...
  function getRelatedData(){
    return  axios.get(`https://kotobekia-backend.onrender.com/api/v1/api/v1/posts/specific/${id}`)
  }
  ...
  return (
    <>
      <section className="postDetails hidden lg:block py-[50px]">
        <div className="container">
          <div className="grid grid-cols-12 gap-8">
            <div className="col-span-8">
              {/* --------- images --------- */}
              <div className="imgs  mb-12">
                <img
                ...
                <div className=" flex items-center justify-start   gap-10">
                  <div className="thumps flex gap-6 ">
                    <div className="">
                      <img
                        src="../../../public/assets/imgPost.png"
                        alt=""
                        className="rounded-2xl w-[120px] h-[100px]"
                      />
                    </div>
              ...
              <div className="aboutBooks relative  text-end pt-8 rounded-xl bg-[#F3F4F7]">
                ...
                <div className=" pe-3 ps-10">
                  ...
                  <p className="text-base text-[#0F172A] ">
                    يعتقد البعض أن عدد الأحرف هو إجمالي عدد الأحرف في النص. على
                    الرغم من ذلك، إلا أنه يمثل العدد الإجمالي لجميع الأحرف، بما
                    في ذلك المسافات. غالبًا ما تكون عدد الأحرف مطلوبة عندما تكون
                    هناك ضرورة إلى أن{" "}
                  </p>
              ...
              {/* --------- Book Details --------- */}
                    <div className="bookDetails mt-10">
                      ...
                      <div className="item grid grid-cols-2 my-3 pb-3 border-b-1 border-white">
                        <span className="text-[#0F172A] text-base block  font-semibold ">الثالث</span>
                        <span className="text-[#939393] text-base block text-end font-semibold ">الصف</span>
                      </div>

                      <div className="item grid grid-cols-2 my-3 pb-3 border-b-1 border-white">
                        <span className="text-[#0F172A] text-base block  font-semibold ">ثانوي</span>
                        <span className="text-[#939393] text-base block text-end font-semibold ">المرحلة التعليمية</span>
                      </div>

                      <div className="item grid grid-cols-2 my-3 pb-3 border-b-1 border-white">
                        <span className="text-[#0F172A] text-base block  font-semibold ">عام</span>
                        <span className="text-[#939393] text-base block text-end font-semibold ">نوع التعليم</span>
                      </div>

                      <div className="item grid grid-cols-2 my-3 pb-3 border-b-1 border-white">
                        <span className="text-[#0F172A] text-base block  font-semibold ">2020 - 2021</span>
                      ...
                      <div className="item grid grid-cols-2 mt-3">
                        <span className="text-[#0F172A] text-base block  font-semibold ">اﻷول</span>
            ...
            {/* ****************** Data for User ****************** */}
            <div className="details  col-span-4">
              ...
              <div className="pesronalData bg-white rounded-lg border-1 border-[#E8E7E7] ">
                <div className="data flex justify-center my-3">
                  <div className="userName me-2 ">
                    ...
                    <span className="text-[10px] underline text-black block text-end">
                      عرض الملف الشخصي{" "}
                    </span>
                  </div>
                  ...
                  <div className="contact">
                    <div className="item flex mb-3  gap-1 items-center ">
              ...
              <div className="mapLocation mb-6">
                <h2 className="text-base text-black font-semibold mt-3 mb-2">
                  الموقع علي الخريطه{" "}
                </h2>
                <div className="map">
          ...
          <PartsOfCategory title={"Related posts"} data={data?.data?.result[1]} />
      </section>
    </>
  );
};
