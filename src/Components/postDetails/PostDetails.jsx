                ...
                <div className="lg:grid lg:grid-cols-12 gap-8">
                    ...
                    <div className="aboutBooks relative  text-end pt-8 rounded-xl bg-[#F3F4F7]">
                      ...
                      <div className=" pe-3 ps-10">
                        ...
                        <p className="text-base text-[#0F172A] ">
                          يعتقد البعض أن عدد الأحرف هو إجمالي عدد الأحرف في
                          النص. على الرغم من ذلك، إلا أنه يمثل العدد الإجمالي
                          لجميع الأحرف، بما في ذلك المسافات. غالبًا ما تكون عدد
                          الأحرف مطلوبة عندما تكون هناك ضرورة إلى أن{" "}
                        </p>
                  ...
                  <div className="details mt-5  lg:col-span-4">
                    ...
                    <div className="ads cursor-pointer">
                      <img
                        src="../../../public/assets/images/ad/ads.png"
                        alt="ads"
