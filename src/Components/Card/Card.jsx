...
function Card({ data }) {
  return (
    <>
      <div className=" m-auto h-full pt-1 ">
        <div className=" mx-2">
          <img className="w-[100%]" src="/assets/cardImg.png" alt="img" />
          <div className="txt bg-white py-2 px-3 rounded-b-[14px]">
            <div className="card-title flex items-center justify-between gap-2">
              <h3 className=" text-[14px] md:text-[16px] text-black font-semibold  line-clamp-1">
                aladwaa books
              </h3>

              <span className="  py-[2px] px-[10px] text-[12px] bg-[#d4f7ef] text-[#38BC9C]  rounded-[8px]">
                Free
              </span>
            </div>

            <div className="cardDesc my-3">
              <p className="m-0 text-[10px] md:text-sm text-[#464646]   line-clamp-2 ">
            ...
            <div className="cardAddress flex items-center justify-between sm:text-[14px] text-xs">
              <div className="address flex gap-1 items-center ">
                ...
                <span className="text-[#464646] text ">AL-Mansoura</span>
              </div>
