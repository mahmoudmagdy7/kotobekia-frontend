        ...
        <div className="container">
          ...
          <div className="form mt-4">
            <form action="">
              ...
              {/* ------- Gendar ------- */}
              <div className="form-group mb-4">
                <span className="text-base text-[#131313] font-medium block">
                  الجنس
                </span>
            ...
            <p className="text-[#131313] text-[13px] font-bold text-center mt-6">لديك حساب؟  <Link to={"/auth/login"} className="text-[#28D8AE] underline">تسجيل الدخول</Link></p>
          </div>
          {/* -------- Form --------  */}
