      ...
      <div className="navBar flex items-center gap-5">
        ...
        <div className="navbar-form bg-[#F3F4F7] flex-1 md:lg:w-[590px] lg:lg:w-[600px] rounded-[12px] ">
          <div className="input relative ">
            <input type="text" placeholder="Search for books" className="input  block ps-4 h-[48px]  text-[#939393] bg-transparent w-full  outline-none" />
          ...
          <div className="navbar-setting lg:hidden  flex items-center gap-1 cursor-pointer">
            ...
            <div className="alarm relative">
              <svg xmlns="http://www.w3.org/2000/svg" width="41" height="40" viewBox="0 0 41 40" fill="none">
                <rect opacity="0.1" x="0.38501" width="40" height="40" rx="20" fill="#FA5057" />
                <path
