...
const NavScroll = ({ locationName, handleLocationName }) => {
  /**
   * From < Mojanad >
   * ===========================================================
   *
   * Set the click in the whole field of the location selection
   * Save the user location in the local storage                     Done
   * Change "select a location" to => the user location              Done
  ...
  return (
    <>
      <div
        ...
        className=" fixed z-[49]  w-full top-0 shadow-[0_10px_20px_-15px_rgba(0,0,0,0.2)]  start-0 transition-all "
      >
