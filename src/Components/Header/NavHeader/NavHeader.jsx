...
const NavHeader = () => {
        ...
        <div className="navBar flex items-center gap-5">
          ...
          <div className="user hidden lg:flex items-center gap-3">
            ...
            <div className="name text-[12px]">
              ...
              <span className="text-[#1F292F] font-semibold">Your account</span>
            </div>
          </div>
          {/* Desktop user  */}
  ...
  // Navbar when render make scroll
  function NavbarScroll() {
    return (
      <>
        <>
          {/* ########## when user make scroll ##########  */}
          <div
            style={{
              background: "linear-gradient(90deg, #e0e1f5 0%, #f2f1e3 100.31%)",
            }}
            className="navbar fixed z-[99999999999] w-full top-0 shadow-[0_10px_20px_-15px_rgba(0,0,0,0.2)] start-0 transition-all"
          >
            <div className="container navBar flex items-center gap-5 py-3">
              ...
              {/* --------- Setting section form Mobile to Tablet --------- */}
              <div className="navbar-setting lg:hidden  flex items-center gap-1 cursor-pointer">
                <solarIcons.Tuning size={26} color="#1C274C" />
                <div className="alarm relative">
                  <svg
              ...
              {/* --------- notifcations icons for Desktop --------- */}
              <div className="notifcations hidden lg:flex items-center cursor-pointer gap-4">
                <div className="msg relative fill-[#1C274C]">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="container">
          <div className="nav_top flex items-center justify-between">
            <div className=" flex items-center  flex-1 justify-between  md:justify-start gap-6">
              ...
              {/* --------- Language for Mobile ---------*/}
              <div
                className="navbar-lang  flex items-center bg-[#F3F4F7] w-10 cursor-pointer lg:hidden justify-center gap-[5px] rounded-[10px]"
                style={{ fontFamily: "Noto Sans Arabic" }}
              >
                <Button
                  size="sm"
