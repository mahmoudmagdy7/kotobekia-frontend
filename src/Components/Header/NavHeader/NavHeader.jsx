        ...
        <div className="container">
          <div className="nav_top flex items-center justify-between">
            <div className="start flex items-center  flex-1 justify-between  md:justify-start gap-6">
              ...
              {/* Mobile-Location */}
              <div className="navbar-location  px-4  flex lg:hidden w-[150px] justify-center items-center gap-[10px] rounded-[8px] py-1  cursor-pointer bg-[#F3F4F7]">
                <div className="txt">
