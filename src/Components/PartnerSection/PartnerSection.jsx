      ...
      <section className="partners py-10 ">
        <div className="title mx-auto relative">
          ...
          <div
            style={{ zIndex: "1" }}
            className={
              `   absolute bottom-[3px]  stroke-[4px] start-1/2 ${localStorage.getItem("i18nextLng") == "ar" ? "translate-x-1/2" : "-translate-x-1/2"}`
              //
            }
          >
        ...
        {/* <div className="partnersLogo my-10 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-10 items-center "> // better way to use flex to customize it as you like */}
